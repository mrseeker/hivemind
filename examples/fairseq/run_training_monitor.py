...
from transformers import XGLMConfig, XGLMForCausalLM, HfArgumentParser, get_linear_schedule_with_warmup
...
class CheckpointHandler:
    def __init__(
        ...
        config = XGLMConfig.from_pretrained(monitor_args.model_config_path)
        self.model = XGLMForCausalLM(config)
